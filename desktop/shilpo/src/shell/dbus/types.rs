...
pub struct ShellTelemetry {
    ...
    pub polkit_state: String,
    pub polkit_last_error: String,
    pub polkit_helper_path: String,
    pub idle_service_available: bool,
    pub idle_state: String,
    pub idle_last_error: String,
    ...
    pub lock_last_error: String,
    pub lock_last_spawn_reason: String,
