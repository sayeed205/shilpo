...
- `shell`: Shell daemon — top bar, workspace overview, notifications, OSD, extension surfaces, action dispatcher, and `org.shilpo.Shell` D-Bus control plane (see [ADR-0014](../../docs/adr/0014-dbus-shell-control-plane.md)).
