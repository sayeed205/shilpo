...
- **[`extensions/world-clock`](https://github.com/shilpo-rs/shilpo-extensions/tree/main/world-clock)**: Reference Rust implementation showcasing widget contributions, settings integration, and event subscriptions.
