...
mod tests {
    ...
    fn connected_radii_follow_position_and_axis() {
        let first = corner_radii(ButtonGroupMode::Connected, Axis::Horizontal, 0, 3);
        let middle = corner_radii(ButtonGroupMode::Connected, Axis::Horizontal, 1, 3);
        let last = corner_radii(ButtonGroupMode::Connected, Axis::Vertical, 2, 3);
